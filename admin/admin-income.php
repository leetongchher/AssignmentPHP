          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                $ret = "SELECT SUM(u_price) as total from tms_user group by u_id";
              ...
              <div class="text-center">
                <button onclick="window.print()" class="btn btn-success font-weight-bold font-italic">Print</button>
              </div>
            </div>
          </div>
